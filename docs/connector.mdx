...
The Ramp connector supports two authentication methods:

- **Access Token**: Use a Ramp API access token
- **OAuth 2.0 Client Credentials**: Use OAuth client credentials (client ID and client secret)

Choose the appropriate secrets configuration for your authentication method:
